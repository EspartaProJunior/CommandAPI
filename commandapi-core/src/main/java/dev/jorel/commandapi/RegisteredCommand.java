 ...
 * @param usageDescription  An {@link Optional} containing this command's help's usage
...
public record RegisteredCommand(
	...
	// The default implementation of `hashCode`, `equals`, and `toString` for records don't work for arrays,
